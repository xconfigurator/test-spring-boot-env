...
public class CookieConfig {
    ...
    @Value("${liuyang.cookie.defaultcookieserializer.domainname}")
    private String DOMAIN_NAME;

    @Value("${liuyang.cookie.defaultcookieserializer.cookiename}")
    ...
    public CookieSerializer cookieSerializer() {
        ...
        defaultCookieSerializer.setDomainName(DOMAIN_NAME);
